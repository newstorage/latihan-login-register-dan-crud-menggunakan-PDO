 ...
 * https://www.itechempires.com/2016/06/php-login-registration-system-with-php-data-object-pdo/amp/
...
class UserController
{
    ...
    public function UserDetails($user_id)
    {
        try {
            $database = new Database();
            $db = $database->getConnection();
            $query = $db->prepare("SELECT user_id, name, username, email, password FROM users WHERE user_id=:user_id");
